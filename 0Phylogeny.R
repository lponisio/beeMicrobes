...
dated.tree <- read.tree("../sunflower_saved/data/tree/calibees-206t-95p-spruceup-iqtree-swsc-gtrg.tre")
...
ggtree(phylo) + geom_tiplab() + geom_treescale()

ggsave("../sunflower_saved/data/tree/comm_phylo.pdf", width=40)
